...
public class MyfirstprojectApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Category cat1 = new Category(null, "Eletronics"); //instanciando duas categorias
		Category cat2 = new Category(null, "Books");

		Product p1 = new Product(null, "TV", 2200.00, cat1); //instanciando quatro produtos
		...
		cat1.getProducts().addAll(Arrays.asList(p1, p3)); //cada produto terá sua categoria, e cada categoria, terá sua lista de produtos. 
